...
export class App implements OnInit {
  ...
  async loadMetrics(): Promise<void> {
    ...
    try {
      const response = await fetch('https://smart-food-cycle.onrender.com/api/metrics');
  ...
  async submitAiPlan(): Promise<void> {
    ...
    try {
      const response = await fetch('https://smart-food-cycle.onrender.com/api/ai-plan', {
        method: 'POST',
  ...
  async submitDonation(): Promise<void> {
    ...
    try {
      const response = await fetch('https://smart-food-cycle.onrender.com/api/donations', {
        method: 'POST',
  ...
  async submitBeneficiary(): Promise<void> {
    ...
    try {
      const response = await fetch('https://smart-food-cycle.onrender.com/api/beneficiaries', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...this.auth.authHeader() },
        body: JSON.stringify({
